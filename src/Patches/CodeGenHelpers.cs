...
public static class CodeGenHelpers
{
    public static void GenerateEntrypoint(ModuleDefinition asm, ReferenceImporter importer, string name, Guid guid, out MethodDefinition load, out MethodDefinition unload, out TypeDefinition typeDef)
    {
        ...
        MethodDefinition onAwake = new MethodDefinition(nameof(ICarbonAddon.Awake),
	        attr,
	        MethodSignature.CreateInstance(asm.CorLibTypeFactory.Void, eventArgsRef));
        ...
        // define on loaded
        load = new MethodDefinition(nameof(ICarbonAddon.OnLoaded),
	        attr,
            MethodSignature.CreateInstance(asm.CorLibTypeFactory.Void, eventArgsRef));
